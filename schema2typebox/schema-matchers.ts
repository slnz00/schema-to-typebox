...
export type StringEnumSchema = JSONSchema7 & { type: 'string'; enum: JSONSchema7Type[] };
export const isStringEnumSchema = (schema: JSONSchema7): schema is EnumSchema => {
  return schema["enum"] !== undefined && schema.type === 'string';
};
